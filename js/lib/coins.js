...
export function computeCoins({
    ...
    return wordsAdded * 1 + testsTaken * 1 + testsCorrect * 1 + badgeCount * 5 + parkedCars * 1;
}
...
export const SHOP = {
    ...
    roundabout: {
        ...
        placeable: true,
        surface: "roundabout",
        desc: "A 3×3 road circle with four connected entries",
    },
    ocean: {
        name: "Ocean Block",
        icon: "🌊",
        ...
        placeable: true,
        surface: "ocean",
        desc: "A deep-water tile for boats and bridges",
    },
    beach: {
        name: "Beach Block",
        icon: "🏖️",
    ...
    parking: {
        ...
        placeable: true,
        surface: "parking",
        desc: "Park a car here to earn a coin",
    },
    roadbridge: {
        name: "Road Bridge",
        icon: "🌉",
        ...
        placeable: true,
        surface: "roadbridge",
        desc: "Carries roads across ocean blocks",
    },
    railbridge: {
        name: "Rail Bridge",
        icon: "🚆",
        ...
        placeable: true,
        surface: "railbridge",
        desc: "Carries railway across ocean blocks",
    },
    station: {
    ...
    airportterminal: {
        ...
        placeable: true,
        terminal: true,
        desc: "Connects to the nearest runway and creates a gate",
    },
    car: {
        name: "Car",
        icon: "🚗",
    ...
    doubledeckerbus: {
        ...
        placeable: true,
        vehicle: "road",
        desc: "Two-level bus — drives roads and stops at stations",
    },
    train: {
        name: "Train",
        icon: "🚂",
    ...
    boat: {
        ...
        placeable: true,
        vehicle: "water",
        desc: "Sails across connected ocean blocks",
    },
    crosswalk: {
        name: "Crosswalk",
        icon: "🚶",
        ...
        placeable: true,
        surface: "crosswalk",
        desc: "A marked crossing for pedestrians",
    },
    pedestrian: {
        name: "Pedestrian",
        icon: "🧍",
        ...
        walk: true,
        animal: true,
        desc: "Walks around and uses crosswalks",
    },
