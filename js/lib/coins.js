...
// cat:   shop-grid grouping ('paths' | 'transit' | 'attractions' | 'waterfront' | 'decor' | 'animals' | 'structures' | 'themes').
...
export const SHOP = {
    ...
    // --- Paths and infrastructure: buy many, drag onto blocks, rearrange any time ---
    road: {
        name: "Road",
        icon: "🛣️",
        cost: 5,
    ...
    slide: {
        ...
        placeable: true,
        attraction: true,
        desc: "A bright little slide for the playground",
    },
    swings: {
        name: "Swing Set",
        icon: "🎠",
        ...
        placeable: true,
        attraction: true,
        desc: "A cheerful swing set with moving seats",
    },
    seesaw: {
        name: "Seesaw",
        icon: "⚖️",
        ...
        placeable: true,
        attraction: true,
        desc: "A colorful seesaw for two",
    },
    sandbox: {
        name: "Sandbox",
        icon: "🟨",
        ...
        placeable: true,
        attraction: true,
        desc: "A sunny sandbox with wooden corners",
    },
    climbingframe: {
        name: "Climbing Frame",
        icon: "🧗",
        ...
        placeable: true,
        attraction: true,
        desc: "A friendly little climbing frame",
    },
    merrygoRound: {
        name: "Merry-Go-Round",
        icon: "🎡",
        ...
        placeable: true,
        attraction: true,
        desc: "A small spinning carousel",
    },
    pendulumride: {
        name: "Pendulum Ride",
        icon: "🎢",
        ...
        placeable: true,
        attraction: true,
        desc: "A compact swinging background ride",
    },
    rollercoaster: {
        name: "Roller Coaster",
        icon: "🎢",
        ...
        placeable: true,
        attraction: true,
        desc: "A compact colorful coaster landmark",
    },
    car: {
        name: "Car",
        icon: "🚗",
